...
|Third-Party Bots LivePerson Functions|Triggered when a bot, which is using the Third-Party Bots' LivePerson Functions receives a message.<br/> For more details on how to set up a function like this one, please see details [here](liveperson-functions-integrations-conversational-ai.html).|Bot Connector|15|
...
|Third-Party Bots LivePerson Functions|Default Template|A template displaying some basic ways how the "Third-Party Bots LivePerson Functions"-Event can be used.|
